...
export default class SEWOView extends React.Component<ActionsProps,ActionsState> {
  ...
  private async loadListData() {
    try {
      ...
      const tableData = items.map((item: any) => ({
        ...
        Injury_x0020_Date_x0020_Time:item.Injury_x0020_Date_x0020_Time,
        Plant:item.Plant,
  ...
  public render() {
    const columns = [
      ...
      { name: "Name if injured", selector: (row: any) => row.InjuredName, sortable: true },
      { name: "Injury Type", selector: (row: any) => row.InjuryType, sortable: true },
      { name: "Injury Date Time", selector: (row: any) =>DateUtilities.getDateMMDDYYYY(row.Injury_x0020_Date_x0020_Time) , sortable: true },
