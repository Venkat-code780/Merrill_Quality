            ...
            if (itemId > 0) {
                ...
                if (!SMATRes.isHttpRequestError) {
                    if (SMATRes.length) {
                        ...
                        let smatUserGroups = this.props.FormAccessConfiguration["SMAT"];
                        let isGrpAccess = smatUserGroups.some((group:any) => currentUserGroups.includes(group));

                        showSubmit = (editSMATItem.Author.Title == this.props.userDisplayName || isGrpAccess) ? true : false;
                        isEditForm = true;
                    }
                    else {
