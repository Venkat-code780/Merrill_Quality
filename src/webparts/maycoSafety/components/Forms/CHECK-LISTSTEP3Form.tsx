...
import "../CSS/CHECKLISTSTEP3Form.css";
...
export interface CHECKLISTSTEP3FormState{
 ...
 export default class CHECKLISTSTEP3Form extends React.Component<CHECKLISTSTEP3FormProps,CHECKLISTSTEP3FormState>{
    ...
    public componentDidMount(): void {
        highlightCurrentNav("liCHECKLISTSTEP3Form");
                    ...
                    <div className="container-fluid">
                        <div className="light-box border-box-shadow mb-4 brd-f1f1f1">
                            <div className="m-0 px-2">
                                <div className="col-12"><h2 className="mb-0 mt-2 text-center"> CHECKLISTSTEP3 Form</h2></div>
                            </div>
                            <div className="row">
