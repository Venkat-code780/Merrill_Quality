...
export interface JSRACategoryProps {
    match: any;
    spContext: any;
...
export interface JSRACategoryState {
...
export default class JSRACategories extends React.Component<JSRACategoryProps, JSRACategoryState> {

    private ActionsList = "JSRACategories";
    private txtJSRACategory;


    private sp = spfi().using(SPFx(this.props.context));

    constructor(props: JSRACategoryProps) {
        super(props);
        ...
        this.txtJSRACategory = React.createRef<HTMLInputElement>();
            ...
            await this.sp.web.lists.getByTitle(this.ActionsList).items.getById(Id)().then((item: any) => {
                if (item.Error) {
                    ...
                    this.setState({
                        ...
                        this.txtJSRACategory.current?.focus();
                    });
                }
            })
        }
                                            ...
                                            <div className="row">
                                                <div className="col-md-3">
                                                    <div className="light-text">
                                                        <input className="form-control" required={true} type="text" name="Title" title={this.state.formData.Title} value={this.state.formData.Title} onChange={this.handleChangeDynamic} id="txtLeadSourceName" autoComplete="off" ref={this.txtJSRACategory} maxLength={250} />
