...
import "../CSS/CHECKLISTSTEP1Form.css";
...
export interface CHECKLISTSTEP1FormProps {
    match: any;
    spContext: any;
...
export interface CHECKLISTSTEP1FormState {
}

export default class CHECKLISTSTEP1Form extends React.Component<CHECKLISTSTEP1FormProps, CHECKLISTSTEP1FormState> {
    ...
    public state = {
        ...
        CheckListTable: {
            'Corporate / Plant Safety Policy': [
                { No: 0, Checks: 'A plant policy exists that defines Safety guidelines and principles. (Work Rules, Safety Guidebook)', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 1, Checks: 'Safety Pledge/ iCare is posted and communicated.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 2, Checks: 'Workers are trained and informed regarding policy contents.(Orientation, 7 Minute Trainers, Shift huddles,etc)', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 3, Checks: 'Training Needs Matrix is established and training is scheduled to meet requirements.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 4, Checks: 'All employees receive the Mayco Safety/Environmental Orientation Training.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 5, Checks: 'All employees receive the Mayco Safety Guide.	', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 6, Checks: 'All employees are trained in awareness of Lockout Tagout procedures. Authorized employees have been trained on LOTO procedures and have been provided', Low: 1, Medium: 2, High: 3, AuditScore: '', Score: [1, 2, 3], Comments: '' },
                { No: 7, Checks: 'Machine Guarding is in place on equipment and employees have completed awareness training.', Low: 1, Medium: 2, High: 3, AuditScore: '', Score: [1, 2, 3], Comments: '' },
                { No: 8, Checks: 'OSHA 300 log is updated/Summary posted Feb 1st- April 30th', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 9, Checks: 'Compliance Calendar established, responsibility identified and monitored for all required inspections/reporting (OSHA, DEQ,Federal,State,Local requirements,etc.)', Low: 1, Medium: 2, High: 3, AuditScore: '', Score: [1, 2, 3], Comments: '' },
            ],
            'Safety Pillar': [
                { No: 10, Checks: 'Safety Pillar training has been carried out, the management and operating units know the contents.', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 11, Checks: 'Roles and responsibilities for the Safety Pillar have been identified.', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 12, Checks: 'Safety Training Matrix has been created and established.', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 13, Checks: 'There is a plan for establishing Share Point to develop S matrix and complete all Safety forms electronically.', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 14, Checks: 'SEWO forms are used for all injuries and significant near misses.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
            ],
            'Emergency Response': [
                { No: 15, Checks: 'Emergency First Responders have been identified and trained on all shifts.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 16, Checks: 'Fire Extinguishers are marked, accessible and inspected to date.', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
                { No: 17, Checks: 'Emergency eyewash/shower(s) are available as required and inspected to date.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 18, Checks: 'Emergency Procedures exist and employees are trained annually on evacuation, fire and spill procedures.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 19, Checks: 'Evacuation map(s) is visible throughout facility, routes are clear, exits are clear.	', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 20, Checks: 'Chemicals are stored properly, Spill procedures and spill kits exist, employees trained on the procedures, hazards, PPE.', Low: 1, Medium: 2, High: 3, AuditScore: '', Score: [1, 2, 3], Comments: '' },
                { No: 21, Checks: 'First Aid kits/BBP/AED are available and inspected as required.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
            ],
            'Assessment of risks (JSRA)': [
                { No: 22, Checks: 'A workplace risk assessment exists for potential hazards such as Hearing/Noise, Chemical, Dust, etc.)', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 23, Checks: 'Supervisors know the assessment of risks regarding their area of responsibility.', Low: 0, Medium: 1, High: 2, AuditScore: '', Score: [0, 1, 2], Comments: '' },
                { No: 24, Checks: 'SDS easily accessible and maintained.', Low: 0, Medium: 0.5, High: 1, AuditScore: '', Score: [0, 0.5, 1], Comments: '' },
            ]
        },
        TotalAuditScore: '0',
        isEditForm: false,
    ...
    private getOnLoadData = async () => {
        ...
        try {
            ...
            if (ItemId > 0) {
                let CheckListRes:any = await getListItems('CheckListStep1', this.currentSiteURL, 'Author/Title,Author/Id,*', 'Author',`Id eq ${ItemId}`);
    ...
    private InsertOrUpdateData = async (CheckListPostObj: any) => {
        ...
        let ItemId = this.props.match.params.id;
        if (ItemId > 0) {
            await updateListItem('CheckListStep1', this.currentSiteURL, CheckListPostObj, ItemId).then(async (res: any) => {
                if (!res.isHttpRequestError) {
                    let msg = "Check List Step - 1 updated successfully";
                    this.onSuccess(msg);
                }
            }, (error: any) => {
                console.log(error);
            ...
            await addListItem('CheckListStep1', this.currentSiteURL, CheckListPostObj).then(async (res: any) => {
                //let adedItemId = res.Id;
                console.log(res)
                if (!res.isHttpRequestError) {
                    let msg = "Check List Step - 1 submitted successfully";
                    this.onSuccess(msg);
                }
            }, (error: any) => {
                console.log(error);
    ...
    private CheckDuplicate = async () => {
        ...
        let CheckListName = 'CheckListStep1', CheckFilterQuery = `Plant eq '${this.state.formData.Plant}' and Department eq '${this.state.formData.Department}' and Zone eq '${this.state.formData.Zone}' and Machine eq '${this.state.formData.Machine}' and Shifts eq '${this.state.formData.Shift}' and (Date ge '${startDate}' and Date lt '${endDate}')`;
    ...
    private handleTableChange = (Topic: any, index: any, field: any, value: any) => {
        ...
        if (field == 'AuditScore') {
            ...
            TotalAuditScorePercent = ((TotalAuditScore / 45) * 100).toFixed(2);
        }
                    ...
                    <div className="container-fluid">
                        <div className="light-box border-box-shadow">
                            <div className="m-0 titlebg">
                                <h3 className="mb-0 pt-2 text-center">{" Mayco International - WCM Safety Pillar Step Audits - Level 1 " + (this.state.isEditForm ? (" - " + this.state.ItemId) : "")} </h3>
