                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-3">
                                                            <div className="form-floating">
                                                                <input className="form-control" required={true} placeholder="UAType" type="text" name="Title" title="UAType" value={ this.state.formData.Title} onChange={this.handleChangeDynamic} id="txtLeadSourceName" autoComplete="off" ref={this.txtLeadSourceName} maxLength={250}/>
